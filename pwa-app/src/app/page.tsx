  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center min-h-screen bg-gradient-to-tr from-slate-50 via-slate-100 to-indigo-50/50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950/20">
      <div className="flex flex-col items-center max-w-sm md:max-w-xl px-6 md:px-10 text-center animate-fade-in">
        ...
        <div className="relative w-28 h-28 mb-8 flex items-center justify-center rounded-2xl bg-white dark:bg-slate-900 shadow-xl shadow-indigo-100 dark:shadow-none border border-slate-100 dark:border-slate-800 animate-pulse">
          <Image
            src="/images/therahome-logo-black.png"
            alt="TheraHome Logo"
            width={80}
            height={80}
            priority
